    ...
    public function __invoke(): Closure
    {
        return
            ...
            static function (callable ...$callbacks): Closure {
                ...
                $pipe = MatchOne::of()(FPT::thunk()(true))(...FPT::map()(static fn (callable $callback): callable => static fn ($value, $key, Iterator $iterable): bool => FPT::operator()(Operator::OP_EQUAL)($value)($callback($value, $key, $iterable)))($callbacks));
