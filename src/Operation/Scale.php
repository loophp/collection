...
final class Scale extends AbstractOperation
{
     ...
     * @pure
     *
     * @return Closure(float): Closure(float): Closure(float): Closure(float): Closure(float): Closure(Iterator<TKey, <|float|int|int>): Generator|TKey, float>
     */
    public function __invoke(): Closure
    {
        return
            /**
             * @return Closure(float): Closure(float): Closure(float): Closure(float): Closure(Iterator<TKey, <|float|int|int>): Generator|TKey, float>
             */
            static fn (float $lowerBound): Closure =>
                /**
                 * @return Closure(float): Closure(float): Closure(float): Closure(Iterator<TKey, <|float|int|int>): Generator|TKey, float>
                 */
                static fn (float $upperBound): Closure =>
                    /**
                     * @return Closure(float): Closure(float): Closure(Iterator<TKey, <|float|int|int>): Generator|TKey, float>
                     */
                    static fn (float $wantedLowerBound = 0.0): Closure =>
                        /**
                         * @return Closure(float): Closure(Iterator<TKey, <|float|int|int>): Generator|TKey, float>
                         */
                        static fn (float $wantedUpperBound = 1.0): Closure =>
                            /**
                             * @return Closure(Iterator<TKey, <|float|int|int>): Generator|TKey, float>
                             */
