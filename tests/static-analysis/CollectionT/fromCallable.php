 ...
 */
function fromCallableT_checkList(Collection $collection): void
{
}
/**
...
/** @var Closure(): Generator<int, int> $generatorClosureList */
...
fromCallableT_checkList(Collection::fromCallable($generatorClosureList));
...
fromCallableT_checkList(Collection::fromCallable($arrayList));
fromCallableT_checkMap(Collection::fromCallable($arrayMap));
fromCallableT_checkMixed(Collection::fromCallable($arrayMixed));

fromCallableT_checkList(Collection::fromCallable($arrayIteratorList, 1, 3));
...
fromCallableT_checkList(Collection::fromCallable([$classWithMethod, 'getValues']));
...
fromCallableT_checkList(Collection::fromCallable([$classWithStaticMethod, 'getValues']));
...
fromCallableT_checkList(Collection::fromCallable($invokableClassList));
